  ...
  <div class="purchase">
    ...
    <div class="purchase-info">
      ...
      <div class="underline spaced">
        <p>N° de commande : <strong>{{ purchase.id }}</strong></p>
        <p>Date de commande : <strong>{{ purchase.date }}</strong></p>
        <p>Date de livraison : <strong>{{ purchase.delivery }}</strong></p>
      </div>

      <PurchaseMonitor :step="purchase.deliveryStep" />

      <ToggledBlock title="Informations sur les retours" 
        title-class="" 
